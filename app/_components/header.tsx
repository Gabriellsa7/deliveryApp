      ...
      <div>
        {isOpen ? (
          <>
            ...
            ></div>
            <div className="fixed top-0 right-0 z-10 flex flex-col h-screen w-4/5 overflow-y-auto bg-white items-center justify-start transform transition-transform duration-300 ease-in-out translate-x-0">
